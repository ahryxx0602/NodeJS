  ...
  if (dataSend.language === "en") {
    result = `
      ...
      <div style="max-width: 500px; margin: auto; background: #fff; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.07); padding: 32px 24px;">
        ...
        <h2 style="color: #007bff; text-align: center; margin-bottom: 24px;">Appointment Confirmation</h2>
        <p style="font-size: 16px; color: #333;">Dear <b>${dataSend.patientName}</b>,</p>
        <p style="font-size: 15px; color: #333;">You are receiving this email because you have booked an online appointment on <b>Aura Health</b>.</p>
        <div style="background: #f0f4fa; border-radius: 6px; padding: 16px; margin: 18px 0;">
          <p style="margin: 0 0 8px 0; font-size: 15px;"><b>Time:</b> ${dataSend.time}</p>
          <p style="margin: 0 0 8px 0; font-size: 15px;"><b>Doctor:</b> ${dataSend.doctorName}</p>
        </div>
        <p style="font-size: 15px; color: #333;">Note: You can cancel the appointment at least 1 day in advance for a refund.</p>
        <div style="text-align: center; margin: 32px 0;">
          <a href="${dataSend.redirectLink}" target="_blank" style="display: inline-block; background-color: #007bff; color: #fff; padding: 14px 32px; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: bold; box-shadow: 0 2px 6px rgba(0,123,255,0.15); transition: background 0.2s;">Confirm Appointment</a>
        </div>
        <div style="font-size: 14px; color: #888; text-align: center; margin-top: 24px;">Sincerely,<br/>Aura Health</div>
        <div style="text-align: center; margin-top: 18px;">
          <a href="https://www.facebook.com/vanthanh.phan.75286" target="_blank" style="display: inline-block; margin: 0 8px; text-decoration: none;">
            <img src="https://cdn-icons-png.flaticon.com/512/733/733547.png" alt="Facebook" width="28" height="28" style="vertical-align: middle; border-radius: 4px;" />
          </a>
  ...
  if (dataSend.language === "vi") {
    ...
    <div style="background: #f4f6fb; padding: 40px 0; font-family: Arial, Helvetica, sans-serif;">
      <div style="max-width: 500px; margin: auto; background: #fff; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.07); padding: 32px 24px;">
        ...
        <h2 style="color: #007bff; text-align: center; margin-bottom: 24px;">Thông tin hóa đơn khám bệnh</h2>
        <p style="font-size: 16px; color: #333;">Xin chào <b>${dataSend.patientName}</b>,</p>
        <p style="font-size: 15px; color: #333;">Bạn nhận được email này vì đã nhận được hóa đơn khám bệnh online trên <b>Aura Health</b>.</p>
        <p style="font-size: 15px; color: #333;">Lưu ý: Đây là hóa đơn khám bệnh của bạn. Vui lòng kiểm tra chi tiết.</p>
        <div style="font-size: 14px; color: #888; text-align: center; margin-top: 24px;">Xin chân thành cảm ơn!<br/>Aura Health</div>
        <div style="text-align: center; margin-top: 18px;">
          <a href="https://www.facebook.com/vanthanh.phan.75286" target="_blank" style="display: inline-block; margin: 0 8px; text-decoration: none;">
            <img src="https://cdn-icons-png.flaticon.com/512/733/733547.png" alt="Facebook" width="28" height="28" style="vertical-align: middle; border-radius: 4px;" />
  ...
  if (dataSend.language === "en") {
    result = `
      ...
      <div style="max-width: 500px; margin: auto; background: #fff; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.07); padding: 32px 24px;">
        ...
        <h2 style="color: #007bff; text-align: center; margin-bottom: 24px;">Medical Bill Information</h2>
        <p style="font-size: 16px; color: #333;">Dear <b>${dataSend.patientName}</b>,</p>
        <p style="font-size: 15px; color: #333;">You are receiving this email because you have received an online medical bill on <b>Aura Health</b>.</p>
        <p style="font-size: 15px; color: #333;">Note: This is your medical bill. Please check the details.</p>
        <div style="font-size: 14px; color: #888; text-align: center; margin-top: 24px;">Sincerely,<br/>Aura Health</div>
        <div style="text-align: center; margin-top: 18px;">
          <a href="https://www.facebook.com/vanthanh.phan.75286" target="_blank" style="display: inline-block; margin: 0 8px; text-decoration: none;">
            <img src="https://cdn-icons-png.flaticon.com/512/733/733547.png" alt="Facebook" width="28" height="28" style="vertical-align: middle; border-radius: 4px;" />
